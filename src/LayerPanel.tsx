...
export default function LayerPanel({ layerTree, selectedNodeId, groupOptions: _groupOptions, isCollapsed, onSetCollapsed, onToggleVisible, onSelectNode, onToggleGroupExpanded, onSetGroupExpanded, onAddGroup, onAddLayer, onRenameNode, onDeleteNode, onDeleteNodes, onCreateGroupFromNodes, onDropNodeIntoGroup, onDropNodeToRoot, onReorderBefore, onDropNodesIntoGroup, onDropNodesToRoot, onReorderNodesBefore }: { layerTree: LayerTreeNode[]; selectedNodeId: string | null; groupOptions: LayerGroupNode[]; isCollapsed: boolean; onSetCollapsed: (collapsed: boolean) => void; onToggleVisible: (nodeId: string) => void; onSelectNode: (nodeId: string) => void; onToggleGroupExpanded: (groupId: string) => void; onSetGroupExpanded: (groupId: string, expanded: boolean) => void; onAddGroup: () => void; onAddLayer: () => void; onRenameNode: (nodeId: string, newName: string) => void; onDeleteNode: (nodeId: string) => void; onDeleteNodes: (nodeIds: string[]) => void; onCreateGroupFromNodes: (nodeIds: string[]) => void; onDropNodeIntoGroup: (nodeId: string, groupId: string) => void; onDropNodeToRoot: (nodeId: string) => void; onReorderBefore: (activeId: string, overId: string) => void; onDropNodesIntoGroup: (nodeIds: string[], groupId: string) => void; onDropNodesToRoot: (nodeIds: string[]) => void; onReorderNodesBefore: (nodeIds: string[], overId: string) => void; }) {
