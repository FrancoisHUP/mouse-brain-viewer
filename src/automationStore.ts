...
const AUTOMATION_PIPELINES_STORAGE_KEY = "mouse-brain-viewer:automation-pipelines:v1";
const AUTOMATION_CUSTOM_TOOLS_STORAGE_KEY = "mouse-brain-viewer:automation-custom-tools:v1";
